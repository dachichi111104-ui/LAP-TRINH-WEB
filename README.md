...
2. Tải tệp "webdienthoai" từ github repo này, giải nén và copy toàn bộ thư mục
...
6. Tạo database "webdienthoai"

7. Import `webdienthoai.sql` file vào database vừa tạo

8. Paste URL này vào trình duyệt `http://localhost/webdienthoai/index.php`

9. Để truy cập trang quản lý, sử dụng link tài khoản sau:
    
   `http://localhost/webdienthoai/loginadmin.php`

   `tài khoản:  lengoctrinh2712@gmail.com`
